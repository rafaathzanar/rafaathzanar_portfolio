    ...
    <div className="mt-10"></div>
      ...
      <div className="relative grid gap-6 md:grid-cols-2 md:gap-4 md:pb-[0rem]">
        {projects.map((item) => {
          ...
          return (
            <div
              className={`md:flex even:md:translate-y-[0rem] p-0.25 rounded-[2.5rem] w-full ${
        ...
        <div className="mt-4">
          <p className="text-xs font-bold text-n-1">Technologies Used:</p>
            ...
            {item.technologies.map((tech) => (
              ...
              />
                   ...
                   <div style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                        <a
                      href={item.link}
                    className="ml-auto font-code text-[10px] font-bold text-n-1 uppercase tracking-wider transition-transform transform hover:scale-110 hover:text-blue-500 flex items-center"
                    >
